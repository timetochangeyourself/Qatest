...
try:
    ...
    assert EMAIL_ADDRESStest != driver.find_element_by_class_name('address.what_to_copy')
    print("wrong address saved")
...
def check_link(fraim):
    ...
    print("links in letter match links in pages")
    leght = driver.find_elements_by_xpath('/html/body/a')
    quantity = len(leght)
